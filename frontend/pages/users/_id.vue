<template lang="pug">
  section.hero
    div.hero-body
      h1.is-1.has-text-centered Update User Data
      div.card
        div.card-content
          ValidationObserver(v-slot="{ invalid }")
            ...
            b-field(grouped class="between")
              nuxt-link(class="button is-primary is-medium" to="/users")  {{$t('cancel')}}
              b-button(v-if="$userIsSuperuser()" size="is-medium" type="is-info" @click="update" :disabled="invalid") {{$t('update')}}
</template>
