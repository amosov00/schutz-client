<template>
  <div>
        ...
        <div class="columns is-fullheight">
          <div class="column is-half is-flex is-flex-direction-column">
            <div class="is-size-5 mb-5">
              Выводите<br /> или реинвестируйте<br /> полученные дивиденды
            </div>
            <div class="is-size-4">Доступно USDT:</div>
            <div class="is-size-2 mb-5">{{ formatCurrency(totalDividends) }}</div>
            <div class="is-size-7 mb-5 has-text-grey mt-auto">
              Ближайшие дивиденды поступят<br /> 15 января, 2021
            </div>
          </div>
          <div class="column is-half is-flex is-flex-direction-column ">
            <div>
            ...
            <custom-button
              :disabled="!totalDividends || !user.ethereum_wallet || status !=='online'"
    ...
    <b-modal
      :active.sync="withdrawModalActive"
      has-modal-card
    >
      <withdraw-modal />
    </b-modal>
    <b-modal
      :active.sync="reinvestModalActive"
      has-modal-card
    >
      <reinvest-modal />
    </b-modal>
