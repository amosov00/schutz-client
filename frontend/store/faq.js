...
export const actions = {
  ...
  async add({dispatch}, payload) {
    return await this.$axios.post('/admin/faq/', {...payload})
      .then(res => {
        dispatch('fetchList')
  ...
  async remove({dispatch}, id) {
    return await this.$axios.delete(`/admin/faq/${id}/`)
      .then(res => {
        dispatch('fetchList')
  ...
  async setOrder({dispatch}, payload) {
    ...
    return await this.$axios.put(`/admin/faq/${id}/`, data)
      .then(res => {
        dispatch('fetchList')
        Toast.open({message: 'Order successfully saved!', type: 'is-primary'})
        return true
      })
      .catch(e => {
